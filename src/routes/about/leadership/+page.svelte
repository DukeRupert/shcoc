<script lang="ts">
	...
	const staff: Leader[] = [
		...
		},
		{
			...
			image:
				'https://res.cloudinary.com/rr-wholesale/image/upload/v1710183607/South%20Hills%20CoC/IMG_9345_ziigc5.png',
	...
	const elders: Leader[] = [
		{
			...
			image:
				'https://res.cloudinary.com/rr-wholesale/image/upload/v1739151651/South%20Hills%20CoC/ggutnaxxu8k6ltkzgu56.png'
		},
		{
			name: 'Randy & Donna Yaeger',
			image:
				'https://res.cloudinary.com/rr-wholesale/image/upload/f_auto,q_auto/v1/South%20Hills%20CoC/uhr1ed0uum2mawtc1sgr'
		},
		{
			name: 'John & Debbie Kilpatrick',
			image:
				'https://res.cloudinary.com/rr-wholesale/image/upload/v1739151649/South%20Hills%20CoC/urqt14wvsvdofdkdrt3r.png'
		},
		{
			name: 'Allan & Diane Steinle',
			image:
				'https://res.cloudinary.com/rr-wholesale/image/upload/v1739151648/South%20Hills%20CoC/vpfkde7nbifsyhi7dakb.png'
		}
	];
	...
	const deacons: Leader[] = [
		{
			...
			role: 'IT',
			image:
				'https://res.cloudinary.com/rr-wholesale/image/upload/v1739151650/South%20Hills%20CoC/l7ks4pdsgkt5p5dmtlar.png'
		},
		{
			name: 'Chiranjeevi Allada',
			role: 'Finance',
			image:
				'https://res.cloudinary.com/rr-wholesale/image/upload/v1739151650/South%20Hills%20CoC/b0giz6xnbsyewsz37tid.png'
		},
		{
			name: 'Brian Christensen',
			role: 'Benevolence',
			image:
				'https://res.cloudinary.com/rr-wholesale/image/upload/f_auto,q_auto/v1/South%20Hills%20CoC/tedbulr5ossnm004uevg'
		}
	];
</script>
...
{#snippet staffCard(leader: Leader)}
	<div
		class="grid grid-cols-1 gap-8 overflow-hidden rounded-2xl bg-white p-6 shadow-lg lg:grid-cols-2"
	>
		{#if leader.image}
		...
		{:else}
			<div
				class="relative flex h-80 items-center justify-center overflow-hidden rounded-lg bg-violet-100"
			>
				<span class="text-4xl text-violet-400">
					{leader.name
						.split(' ')
						.map((n) => n[0])
						.join('')}
		...
		{#if leader.image}
			<figure>
				<img
					...
					class="mx-auto mb-3 h-64 w-80 rounded-lg object-cover"
				/>
			</figure>
		{/if}
...
<div class="bg-white">
	...
	<div class="relative bg-white py-12 sm:py-16 lg:py-20">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			...
			<h1 class="mb-16 text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
				Leadership
			</h1>
			...
			<div class="mb-16 grid grid-cols-1 gap-8 md:grid-cols-2">
				<div class="rounded-2xl bg-violet-50 p-8">
					<h2 class="mb-4 text-2xl font-semibold text-gray-900">Mission</h2>
				...
				<div class="rounded-2xl bg-violet-50 p-8">
					<h2 class="mb-4 text-2xl font-semibold text-gray-900">Vision</h2>
					<p class="text-lg text-gray-600">
						We will strive to be a community with a clear plan in our organization, ministries,
						events and staffing to intentionally develop disciples, create fellowship, and enrich
						worship.
					</p>
				</div>
			</div>
	...
	<section class="bg-violet-50 py-16">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<h2 class="mb-12 text-3xl font-semibold text-gray-900">Our Staff</h2>
			<div class="space-y-8">
	...
	<section class="py-16">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<h2 class="mb-8 text-3xl font-semibold text-gray-900">Shepherds</h2>
	...
	<section class="bg-violet-50 py-16">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<h2 class="mb-8 text-3xl font-semibold text-gray-900">Deacons</h2>
			<div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
...
<svelte:head>
	<!-- Essential Meta Tags -->
	<title>Our Leadership Team | South Hills Church of Christ - Helena, MT</title>
	<meta
		name="description"
		content="Meet our leadership team led by Lance Love. Our elders, deacons, and staff are committed to developing disciples, creating fellowship, and enriching worship in Helena."
	/>

	<!-- Open Graph / Facebook -->
	<meta property="og:type" content="website" />
	<meta property="og:url" content={`${siteUrl}/about/leadership`} />
	<meta property="og:title" content="Leadership Team - South Hills Church of Christ" />
	<meta
		property="og:description"
		content="Led by Minister Lance Love, our team is dedicated to personal discipleship, committed fellowship, and heartfelt worship. Meet our elders, deacons, and staff."
	/>
	<meta property="og:image" content={`${siteUrl}/og-image.jpg`} />

	<!-- Twitter -->
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:url" content={`${siteUrl}/about/leadership`} />
	<meta name="twitter:title" content="Leadership Team - South Hills Church of Christ" />
	<meta
	...
	<meta
		name="keywords"
		content="church leadership helena, christian leaders montana, church elders helena, church staff montana, minister lance love"
	/>

	<!-- Leadership Organization Schema -->
	<script type="application/ld+json">
		{
			...
			"member": [
				{
					"@type": "Person",
					"name": "Lance Love",
					"jobTitle": "Lead Minister",
					"description": "Focused on developing strong families and leading worship",
			...
			"mission": {
				"@type": "Mission",
				"description": "We will be a people defined by our personal discipleship to Jesus, our committed fellowship with one another, and our heartfelt gathered worship."
			},
			"vision": {
				"@type": "Thing",
				"description": "We will strive to be a community with a clear plan in our organization, ministries, events and staffing to intentionally develop disciples, create fellowship, and enrich worship."
			},
			"leadershipTeam": {
				"@type": "OrganizationRole",
				"roleName": "Church Leadership",
				"description": "Our leadership team consists of our minister, elders, and deacons working together to serve our congregation and community."
			}
		}
	</script>
