<script lang="ts">
    ...
    // basic
    const { title, meta_description: description, canonical_url: canonical } = seo
	// og image
    const img_src = PUBLIC_DIRECTUS_ENDPOINT + '/assets/' + seo.og_image + '?w=1200&h=630';
    ...
    export let author = ""
    export let index = true, openGraph = true;
